...
chunks = [{"latitude" => 48.858391,"longitude" => 2.341461, "receptiontime" => "21:00:18", "content" => "How's it going!","cityname" => "Paris", "countryname" => "France"},{"latitude" => 45.757942,"longitude" => 4.822998, "content" => "Yo!","cityname" => "Lyon", "countryname" => "France", "receptiontime" => "23:42:00"}]
@@count = 0
